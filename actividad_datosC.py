...
print(" "*3)
print("---- 2. Media de gasto europeo entre los años 2012 y 2020 ----")
print(" "*3)
...
print(" "*3)
print("---- 3. ¿Qué país gastó más durante el año 2019?----")
print(" "*3)
...
print(" "*3)
print("---- 4. Serie ordenada del gasto de los paises en el año 2015 ----")
print(" "*3)
